...
const Account: React.FC = () => {
  ...
  const renderAsideMenu = () => (
    <aside>
      <ul>
        <li
          className={selected === 'profile' ? styles.root__selected : ''}
        ...
        <li
          className={selected === 'orders' ? styles.root__selected : ''}
        ...
        <li
          className={selected === 'settings' ? styles.root__selected : ''}
        ...
        {user?.role === 'ADMIN' && (
          <li
            className={selected === 'admin' ? styles.root__selected : ''}
