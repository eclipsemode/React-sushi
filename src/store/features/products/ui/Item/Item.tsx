...
const Item = ({product}: IProps) => {
    ...
    return (
        <div className={styles.root}>
                <Image width={302} loading='lazy' height={170} placeholder='blur' blurDataURL='data:images/blur.png' className={styles.image} src={process.env.REACT_APP_API_URL + product[0]?.image} alt={product[0]?.name} />
