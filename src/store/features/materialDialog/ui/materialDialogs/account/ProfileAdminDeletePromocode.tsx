...
import {deletePromocode, getAllPromoCodes} from "@store/features/promocode/api";
            ...
            <DialogTitle id="responsive-dialog-title">
                ...
                <DialogActions sx={{justifyContent: 'center'}}>
                    <SimpleButton type='reset' color={Colors.$mainColor}
                                  variant='contained' clickEvent={handleDisagree}>Отменить</SimpleButton>
                    <SimpleButton type='submit' variant='contained' clickEvent={handleAgree}>Подтвердить</SimpleButton>
                </DialogActions>
        </>
    );
};
