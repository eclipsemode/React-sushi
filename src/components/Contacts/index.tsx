        ...
        <Box className={styles.box}>
          <Stack spacing={2}>
            ...
            <Stack justifyContent="flex-start" rowGap="10px">
              <span>
                Лайм суши — это японский-итальянский ресторан быстрого питания.
                Осуществляем бесплатную доставку, при заказе от 600 рублей в
                течении 1 часа.
              </span>
              <span>
                Товары могут отличаться от фотографий соответствующих Товаров,
