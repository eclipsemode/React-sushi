...
const CardScroll = ({ cards }: IProps) => {
  const ulElement = React.useRef<HTMLUListElement>(
  ...
  return (
    <>
      <div className={styles.container}>
        <div
          className={styles.arrowContainer + ' ' + styles.arrowContainer__prev}
          onClick={() => handleScroll('left', 310)}
        >
          <ArrowBackIosIcon
            sx={{
              color: Colors.$infoColor,
              '& > path': { transform: 'translateX(3px)' },
            }}
          />
        </div>
        ...
        <div
          className={styles.arrowContainer + ' ' + styles.arrowContainer__next}
